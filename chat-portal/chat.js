...
window.onload = function() {
    ...
    class MEME_CHAT{
      ...
      create_title(){
        ...
        back_btn.innerHTML = '← Back to Home';
        back_btn.setAttribute('style', 'position: absolute; top: 20px; left: 20px; color: #f9c03c; text-decoration: none; font-weight: bold; font-family: sans-serif; background: #1a1a1a; padding: 10px 15px; border-radius: 5px; border: 1px solid #f9c03c; z-index: 1000;');
        document.body.append(back_btn);
